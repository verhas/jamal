...
For example:
  ...
  maven.load.include=com.javax0.jamal:jamal-groovy:2.6.1-SNAPSHOT

* add the line

  {@maven:load com.javax0.jamal:jamal-groovy:2.6.1-SNAPSHOT}
+
...
* To include the resource file `groovy.jim` you have to add the line
  ...
  {@import maven:com.javax0.jamal:jamal-groovy:2.6.1-SNAPSHOT::groovy.jim}
+
