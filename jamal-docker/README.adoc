...
----
docker login
docker buildx build --platform linux/amd64,linux/arm64 -t verhas/jamal:2.8.0 -t verhas/jamal:latest --push .
----
...
[source,sh]
----
docker pull verhas/jamal:2.8.0
docker run  --volume $(pwd):/home/jamal/q -it verhas/jamal:2.8.0 /jamal args
----

NOTE: The examples use the latest release of Jamal, 2.8.0.
