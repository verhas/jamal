...
----
mvn com.javax0.jamal:jamal-maven-plugin:2.0.2:jamal
----
...
----
mvn  -DfilePattern=.*pom\.xml\.jam$ com.javax0.jamal:jamal-maven-plugin:2.0.2:jamal
----
...
----
mvn  -f null.pom -DfilePattern=.*pom\.xml\.jam$ com.javax0.jamal:jamal-maven-plugin:2.0.2:jamal
----
