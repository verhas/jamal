...
----
mvn com.javax0.jamal:jamal-maven-plugin:1.9.0:jamal
----
...
----
mvn  -DfilePattern=.*pom\.xml\.jam$ com.javax0.jamal:jamal-maven-plugin:1.9.0:jamal
----
...
----
mvn  -f null.pom -DfilePattern=.*pom\.xml\.jam$ com.javax0.jamal:jamal-maven-plugin:1.9.0:jamal
----
