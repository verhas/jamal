...
----
mvn com.javax0.jamal:jamal-maven-plugin:1.10.4:jamal
----
...
----
mvn  -DfilePattern=.*pom\.xml\.jam$ com.javax0.jamal:jamal-maven-plugin:1.10.4:jamal
----
...
----
mvn  -f null.pom -DfilePattern=.*pom\.xml\.jam$ com.javax0.jamal:jamal-maven-plugin:1.10.4:jamal
----
