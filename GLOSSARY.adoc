...
User-Defined Macro:: A macro, defined using Jamal macro source.
...
The significant difference between the implementation of built-in macros and user-defined macros is that built-in macros are service objects and user-defined macro classes are not.
...
Some built-in macros can do it.
