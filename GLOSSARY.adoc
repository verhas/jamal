...
Standard Built-In Macro Argument Splitting:: The standard way a built-in macro can parse the Macro Input in case it does not need to implement its syntax analysis.
