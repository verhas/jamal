...
[source,bash]
----
java -cp $HOME/.m2/repository/com/javax0/jamal/jamal-engine/1.7.10-SNAPSHOT/jamal-engine-1.7.10-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-api/1.7.10-SNAPSHOT/jamal-api-1.7.10-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-tools/1.7.10-SNAPSHOT/jamal-tools-1.7.10-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-core/1.7.10-SNAPSHOT/jamal-core-1.7.10-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-cmd/1.7.10-SNAPSHOT/jamal-cmd-1.7.10-SNAPSHOT.jar: javax0.jamal.cmd.JamalMain options
----
...
This is automatically enysured when Jamal is started using jbang using the `jbang jamal@verhas` command.
...
[source]
----
The current version 1.7.10-SNAPSHOT is older than the required version. It has to be newer.
----
...
To be consistent the macro `include` also use the `[` and the `]` characters.
