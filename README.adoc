...
[source,bash]
----
java -cp $HOME/.m2/repository/com/javax0/jamal/jamal-engine/1.7.8/jamal-engine-1.7.8.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-api/1.7.8/jamal-api-1.7.8.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-tools/1.7.8/jamal-tools-1.7.8.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-core/1.7.8/jamal-core-1.7.8.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-cmd/1.7.8/jamal-cmd-1.7.8.jar: javax0.jamal.cmd.JamalMain options
----
...
[source]
----
The current version 1.7.8 is older than the required version. It has to be newer.
----
