= Jamal
:doctitle: Jamal Macro Language

== image:images/logo.svg[width=100px] Jamal Macro Language




****
image::images/jetbrains.svg[Supported,link="https://www.jetbrains.com",width=50px, alt="JetBrains"] Developed using https://www.jetbrains.com/community/opensource/#support[JetBrains OSS License]
...
This is a SNAPSHOT version (1.12.6-SNAPSHOT).
...
image::images/text2text.png[align=center]
...
=== Debugger
image::images/jamaldebugger2559x1089.png[]
...
[source]
----
mvn com.javax0.jamal:jamal-maven-plugin:1.12.6-SNAPSHOT:jamal
----
...
[source,bash]
----
java -cp $HOME/.m2/repository/com/javax0/jamal/jamal-engine/1.12.6-SNAPSHOT/jamal-engine-1.12.6-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-api/1.12.6-SNAPSHOT/jamal-api-1.12.6-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-tools/1.12.6-SNAPSHOT/jamal-tools-1.12.6-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-core/1.12.6-SNAPSHOT/jamal-core-1.12.6-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-cmd/1.12.6-SNAPSHOT/jamal-cmd-1.12.6-SNAPSHOT.jar: javax0.jamal.cmd.JamalMain options
----
...
image::images/evaluationorder.svg[]
...
[source]
----
The current version 1.12.6-SNAPSHOT is older than the required version. It has to be newer.
----
