...
[source,bash]
----
java -cp $HOME/.m2/repository/com/javax0/jamal/jamal-engine/1.8.0/jamal-engine-1.8.0.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-api/1.8.0/jamal-api-1.8.0.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-tools/1.8.0/jamal-tools-1.8.0.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-core/1.8.0/jamal-core-1.8.0.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-cmd/1.8.0/jamal-cmd-1.8.0.jar: javax0.jamal.cmd.JamalMain options
----
...
[source]
----
The current version 1.8 is older than the required version. It has to be newer.
----
