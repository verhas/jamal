...
https://javadoc.io/doc/com.javax0.jamal[JavaDoc]

NOTE: This is the latest development documentation.
This is probably a SNAPSHOT.
To see the documentation of a release you have to follow the link in the documentation <<RELEASES.adoc,RELEASES>>
...
[source,bash]
----
java -cp $HOME/.m2/repository/com/javax0/jamal/jamal-engine/1.7.6-SNAPSHOT/jamal-engine-1.7.6-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-api/1.7.6-SNAPSHOT/jamal-api-1.7.6-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-tools/1.7.6-SNAPSHOT/jamal-tools-1.7.6-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-core/1.7.6-SNAPSHOT/jamal-core-1.7.6-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-cmd/1.7.6-SNAPSHOT/jamal-cmd-1.7.6-SNAPSHOT.jar: javax0.jamal.cmd.JamalMain options
----
...
If you use the `~` character after the keyword `define` then the macro will be evaluated "verbatim" by default.
...
----
{@define x=1966}
{@define a={x}}{@verbatim a} is the same as
{@define ~ a={x}}{a}
----
...
On the other hand when the macro would almost always would be used together with `verbatim` then it makes sense to define the macro to be a verbatim user defined macro.
In the few cases when it would be used without `verbatim` you can use `!` instead in this case.
...
Anything can be a parameter name that does not contain a comma or a closing parentheses and is not a substring of any other parameter.
...
[source]
----
The current version 1.7.6-SNAPSHOT is older than the required version. It has to be newer.
----
