...
When a file includes or imports another file then the location of the included or imported file is given along with the location from where the file is included or imported.
...
In some cases the such hierarchy is given in the error message inside a single file to help locating the error.
