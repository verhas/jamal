...
[source,bash]
----
java -cp $HOME/.m2/repository/com/javax0/jamal/jamal-engine/1.8.1-SNAPSHOT/jamal-engine-1.8.1-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-api/1.8.1-SNAPSHOT/jamal-api-1.8.1-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-tools/1.8.1-SNAPSHOT/jamal-tools-1.8.1-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-core/1.8.1-SNAPSHOT/jamal-core-1.8.1-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-cmd/1.8.1-SNAPSHOT/jamal-cmd-1.8.1-SNAPSHOT.jar: javax0.jamal.cmd.JamalMain options
----
...
[source]
----
The current version 1.8.1-SNAPSHOT is older than the required version. It has to be newer.
----
