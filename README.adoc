...
image:jetbrains.svg[Suppoted,"link=https://www.jetbrains.com",width=50px, align="left", alt="JetBrains"]
Developed using https://www.jetbrains.com/community/opensource/#support[JetBrains OSS License].
...
[source,bash]
----
java -cp $HOME/.m2/repository/com/javax0/jamal/jamal-engine/1.10.5-SNAPSHOT/jamal-engine-1.10.5-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-api/1.10.5-SNAPSHOT/jamal-api-1.10.5-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-tools/1.10.5-SNAPSHOT/jamal-tools-1.10.5-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-core/1.10.5-SNAPSHOT/jamal-core-1.10.5-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-cmd/1.10.5-SNAPSHOT/jamal-cmd-1.10.5-SNAPSHOT.jar: javax0.jamal.cmd.JamalMain options
----
...
[source]
----
The current version 1.10.5-SNAPSHOT is older than the required version. It has to be newer.
----
...
To be consistent the macros `include`, `import`, `eval`, `if`, and `defer` also use the `[` and the `]` characters.
