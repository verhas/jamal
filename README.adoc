...
[source,bash]
----
java -cp $HOME/.m2/repository/com/javax0/jamal/jamal-engine/1.7.8-SNAPSHOT/jamal-engine-1.7.8-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-api/1.7.8-SNAPSHOT/jamal-api-1.7.8-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-tools/1.7.8-SNAPSHOT/jamal-tools-1.7.8-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-core/1.7.8-SNAPSHOT/jamal-core-1.7.8-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-cmd/1.7.8-SNAPSHOT/jamal-cmd-1.7.8-SNAPSHOT.jar: javax0.jamal.cmd.JamalMain options
----
...
The default beavior, skipping new lines after a `\` character that follows a macro close string cannot be switched off.
...
[source]
----
The current version 1.7.8-SNAPSHOT is older than the required version. It has to be newer.
----
