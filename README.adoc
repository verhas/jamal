...
[source,bash]
----
java -cp $HOME/.m2/repository/com/javax0/jamal/jamal-engine/1.11.0-SNAPSHOT/jamal-engine-1.11.0-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-api/1.11.0-SNAPSHOT/jamal-api-1.11.0-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-tools/1.11.0-SNAPSHOT/jamal-tools-1.11.0-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-core/1.11.0-SNAPSHOT/jamal-core-1.11.0-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-cmd/1.11.0-SNAPSHOT/jamal-cmd-1.11.0-SNAPSHOT.jar: javax0.jamal.cmd.JamalMain options
----
...
* `lines` - the option can list ranges of lines to include. The individual ranges can be separated by `,` or `;`.
...
In that case that lines appear reversed.
...
[source]
----
The current version 1.11-SNAPSHOT is older than the required version. It has to be newer.
----
