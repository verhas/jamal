...
[source,bash]
----
java -cp $HOME/.m2/repository/com/javax0/jamal/jamal-engine/1.7.9-SNAPSHOT/jamal-engine-1.7.9-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-api/1.7.9-SNAPSHOT/jamal-api-1.7.9-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-tools/1.7.9-SNAPSHOT/jamal-tools-1.7.9-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-core/1.7.9-SNAPSHOT/jamal-core-1.7.9-SNAPSHOT.jar:$HOME/.m2/repository/com/javax0/jamal/jamal-cmd/1.7.9-SNAPSHOT/jamal-cmd-1.7.9-SNAPSHOT.jar: javax0.jamal.cmd.JamalMain options
----
...
[source]
----
The current version 1.7.9-SNAPSHOT is older than the required version. It has to be newer.
----
