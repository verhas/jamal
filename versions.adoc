...
* `OK`  `MAVEN_JAVADOC_PLUGIN_VERSION` `3.8.0` 
...
* `OK`  `SUREFIRE_PLUGIN_VERSION` `3.3.1` 
...
* `*[red]#NO#*`  `COMMONS_COMPRESS_VERSION` `1.26.2` `*[red]#upgrade to 1.27.0#*`
...
* `*[red]#NO#*`  `ASCIIDOCTORJ_VERSION` `3.0.0-alpha.1` `*[red]#upgrade to 3.0.0-beta.1#*`
...
* `*[red]#NO#*`  `JSOUP_VERSION` `1.17.2` `*[red]#upgrade to 1.18.1#*`