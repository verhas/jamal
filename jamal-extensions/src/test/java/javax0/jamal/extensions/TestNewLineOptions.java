...
public class TestNewLineOptions {
    ...
    void testNewLineSkipping() throws InvocationTargetException, NoSuchMethodException, InstantiationException, BadSyntax, IllegalAccessException {
        TestThat.theInput("{@options nl}By default every character is important and no new line characters are eaten up.\n" +
            ...
            "{z}\\\n" +
            "\n" +
            "See... there is no empty line before this line or before the previous line.").results("By default every character is important and no new line characters are eaten up.\n" +
            "Therefore the following to lines will be like: \"alma \\n alma \\n \"\n" +
            "alma\\\n" +
            "alma\n" +
