...
== <<jamal-api/README.adoc, API>> ^_core_^
...
== <<jamal-asciidoc/README.adoc, ASCIIDOC>> ^_embed_^
...
== <<jamal-assertions/README.adoc, ASSERTIONS>> ^_macro_^
...
== <<jamal-cmd/README.adoc, CMD>> ^_embed_^
...
== <<jamal-core/README.adoc, CORE>> ^_macro_^
Implements the core built-in macros.

== <<jamal-debug/README.adoc, DEBUG>> ^_debugger_^
...
== <<jamal-jamal/README.adoc, JAMAL>> ^_macro_^
...
== <<jamal-markdown/README.adoc, MARKDOWN>> ^_macro_^
...
== <<jamal-maven-extension/README.adoc, MAVEN-EXTENSION>> ^_embed_^
...
== <<jamal-yaml/README.adoc, YAML>> ^_macro_^
