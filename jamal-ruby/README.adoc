...
For example:
  ...
  maven.load.include=com.javax0.jamal:jamal-ruby:2.1.0-SNAPSHOT

* add the line

  {@maven:load com.javax0.jamal:jamal-ruby:2.1.0-SNAPSHOT}
+
...
* To include the resource file `ruby.jim` you have to add the line
  ...
  {@import maven:com.javax0.jamal:jamal-ruby:2.1.0-SNAPSHOT::ruby.jim}
+
