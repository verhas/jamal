...
* `javax0.jamal.test.extra.TestUndefinedMacroDoesNotMessUpMarkStack::test2 0.002sec`
* `Total: 0.0050sec`
...
// execute a little BASIC formatted code for each XML
* `javax0.jamal.test.core.TestErrorPositions::testSimpleErrors 0.002sec`
* `javax0.jamal.test.core.TestErrorPositions::errorInMacroParameter 0.002sec`
* `javax0.jamal.test.core.TestErrorPositions::errorInPostMacroEvaluation 0.002sec`
* `Total: 0.0060sec`
...
// execute a little BASIC formatted code for each XML
* `javax0.jamal.test.core.TestEnv::testEnv 0.004sec`
* `javax0.jamal.test.core.TestEnv::testEnvThrow 0.002sec`
* `Total: 0.0060sec`
...
// execute a little BASIC formatted code for each XML
* `javax0.jamal.test.tools.params.TestParams::testSimpleParameterJustPresent 0.131sec`
...
* `javax0.jamal.test.tools.params.TestParams::testMissingParameter 0.006sec`
* `javax0.jamal.test.tools.params.TestParams::testSimpleParametersAlternativesUDNo 0.005sec`
* `javax0.jamal.test.tools.params.TestParams::testUnusedParameter 0.004sec`
* `javax0.jamal.test.tools.params.TestParams::testSimpleParametersBetweenOptionalParensMultiLine 0.004sec`
* `javax0.jamal.test.tools.params.TestParams::testSimpleParametersBetweenOptionalParens_ 0.004sec`
* `javax0.jamal.test.tools.params.TestParams::testUnterminatedMLString 0.003sec`
* `javax0.jamal.test.tools.params.TestParams::testUnquotedEmptyString 0.003sec`
* `javax0.jamal.test.tools.params.TestParams::testBooleanParameters 0.005sec`
* `javax0.jamal.test.tools.params.TestParams::testFetchParameters 0.004sec`
* `javax0.jamal.test.tools.params.TestParams::testSimpleParametersOneFromUDMacro 0.003sec`
* `javax0.jamal.test.tools.params.TestParams::testListParametersOneFromUDMacro 0.003sec`
* `javax0.jamal.test.tools.params.TestParams::testUnterminatedString 0.003sec`
* `javax0.jamal.test.tools.params.TestParams::testUnquotedEmptyStringLast 0.002sec`
* `javax0.jamal.test.tools.params.TestParams::testSimpleParametersBetweenParens 0.011sec`
* `javax0.jamal.test.tools.params.TestParams::testSimpleParameters 0.008sec`
* `javax0.jamal.test.tools.params.TestParams::testSimpleParametersAlternativesUDYes 0.003sec`
* `javax0.jamal.test.tools.params.TestParams::testMultiLineString 0.002sec`
* `javax0.jamal.test.tools.params.TestParams::testSimpleParametersOneFromUDMacroOverride 0.002sec`
...
* `javax0.jamal.test.tools.params.TestParams::testMultiLineStringML 0.002sec`
* `javax0.jamal.test.tools.params.TestParams::testUnterminatedLineString 0.003sec`
...
* `javax0.jamal.test.tools.params.TestParams::testSimpleParametersOptionalParenMissing 0.002sec`
* `javax0.jamal.test.tools.params.TestParams::testNonPresentEmptyList 0.002sec`
* `javax0.jamal.test.tools.params.TestParams::testSimpleParametersBetweenParensML 0.002sec`
* `javax0.jamal.test.tools.params.TestParams::testNoUDMacroForBoolean 0.002sec`
* `javax0.jamal.test.tools.params.TestParams::testUndefinedKey 0.007sec`
* `Total: 0.2460sec`
...
* `javax0.jamal.test.extra.TestUdProtection::escapeSaves 0.001sec`
* `javax0.jamal.test.extra.TestUdProtection::verbatimShowsTheEscapeMacrosInserted 0.002sec`
* `javax0.jamal.test.extra.TestUdProtection::escapeDoesNotWorkWithParametersInside 0.001sec`
* `javax0.jamal.test.extra.TestUdProtection::worksWhenSeparatorContainsOtherVerbatim 0.001sec`
* `Total: 0.0090sec`
...
* `javax0.jamal.test.extra.TestUserDefinedScopesAndExport::testUserDefinedScopeLockingNonExport 0.001sec`
* `javax0.jamal.test.extra.TestUserDefinedScopesAndExport::testUserDefinedScopeLockingOneArgument 0.001sec`
* `javax0.jamal.test.extra.TestUserDefinedScopesAndExport::testUserDefinedScopeLockingExport 0.001sec`
* `Total: 0.0070sec`
...
// execute a little BASIC formatted code for each XML
* `javax0.jamal.test.core.TestDefineClass::testJavaDefinedUserDefinedMacro 0.005sec`
* `Total: 0.0050sec`
...
// execute a little BASIC formatted code for each XML
* `javax0.jamal.test.extra.TestUserDefinedPostEval::testPostEval 0.001sec`
* `Total: 0.0010sec`
...
// execute a little BASIC formatted code for each XML
* `javax0.jamal.test.core.TestMacro::testUdAliasDefinedGlobal 0.003sec`
* `javax0.jamal.test.core.TestMacro::testBuiltInAliasDefined 0.006sec`
* `javax0.jamal.test.core.TestMacro::testBuiltInName 0.002sec`
* `javax0.jamal.test.core.TestMacro::testBuiltInAliasDefinedGlobal 0.002sec`
* `javax0.jamal.test.core.TestMacro::testUdAlias 0.002sec`
...
* `javax0.jamal.test.core.TestMacro::testBuiltInAliasDefined2 0.002sec`
...
* `javax0.jamal.test.core.TestMacro::testBuiltInUndefinedEvaluete 0.002sec`
...
* `javax0.jamal.test.examples.TestArray::testInvalidArrayAccesses(String)[2] 0.001sec`
* `javax0.jamal.test.examples.TestArray::testInvalidArrayAccesses(String)[3] 0.002sec`
* `javax0.jamal.test.examples.TestArray::testInvalidArrayAccesses(String)[4] 0.001sec`
* `javax0.jamal.test.examples.TestArray::testValidArrayAccesses(String, String)[1] 0.002sec`
* `javax0.jamal.test.examples.TestArray::testValidArrayAccesses(String, String)[2] 0.001sec`
...
// execute a little BASIC formatted code for each XML
* `javax0.jamal.test.core.TestJshell::testJShellError 0.496sec`
* `javax0.jamal.test.core.TestJshell::testJShellDocument 0.304sec`
* `javax0.jamal.test.core.TestJshell::testJShellExecution 0.345sec`
* `Total: 1.1450sec`
...
// execute a little BASIC formatted code for each XML
* `javax0.jamal.test.core.TestEvalistFor::testEvalistInclude 0.012sec`
* `Total: 0.0120sec`
...
* `javax0.jamal.test.core.TestCore::testMacroMacro 0.001sec`
...
* `javax0.jamal.test.core.TestCore::testDefineDefault 0.001sec`
...
* `javax0.jamal.test.core.TestCore::testOptions 0.002sec`
* `javax0.jamal.test.core.TestCore::testOptions 0.002sec`
* `javax0.jamal.test.core.TestCore::testOptions 0.001sec`
* `javax0.jamal.test.core.TestCore::testAllCoreMacrosB 0.308sec`
* `javax0.jamal.test.core.TestCore::testAllCoreMacrosB 0.195sec`
* `javax0.jamal.test.core.TestCore::testAllCoreMacrosB 0.256sec`
* `javax0.jamal.test.core.TestCore::testFor 0.002sec`
* `javax0.jamal.test.core.TestCore::testFor 0.001sec`
* `javax0.jamal.test.core.TestCore::testFor 0.051sec`
* `javax0.jamal.test.core.TestCore::testFor 0.001sec`
* `javax0.jamal.test.core.TestCore::testFor 0.001sec`
* `javax0.jamal.test.core.TestCore::testFor 0.002sec`
* `javax0.jamal.test.core.TestCore::testFor 0.002sec`
...
* `javax0.jamal.test.core.TestCore::testFor 0.002sec`
* `javax0.jamal.test.core.TestCore::testFor 0.002sec`
* `javax0.jamal.test.core.TestCore::testFor 0.015sec`
...
* `javax0.jamal.test.core.TestCore::testTry 0.001sec`
* `javax0.jamal.test.core.TestCore::testTry 0.003sec`
...
* `javax0.jamal.test.core.TestCore::testUse 0.001sec`
* `javax0.jamal.test.core.TestCore::testUse 0.002sec`
...
* `javax0.jamal.test.core.TestCore::testEval 0.174sec`
...
* `javax0.jamal.test.core.TestCore::testIf 0.001sec`
* `javax0.jamal.test.core.TestCore::testIf 0.001sec`
* `javax0.jamal.test.core.TestCore::testIf 0.0sec`
* `javax0.jamal.test.core.TestCore::testIf 0.001sec`
* `javax0.jamal.test.core.TestCore::testIf 0.001sec`
* `javax0.jamal.test.core.TestCore::testIf 0.001sec`
* `javax0.jamal.test.core.TestCore::testIf 0.001sec`
...
* `javax0.jamal.test.core.TestCore::testRequire 0.001sec`
* `javax0.jamal.test.core.TestCore::testRequire 0.002sec`
* `javax0.jamal.test.core.TestCore::testRequire 0.001sec`
* `javax0.jamal.test.core.TestCore::testRequire 0.001sec`
* `javax0.jamal.test.core.TestCore::testRequire 0.001sec`
...
* `javax0.jamal.test.core.TestCore::testDefine 0.001sec`
* `javax0.jamal.test.core.TestCore::testDefine 0.001sec`
* `javax0.jamal.test.core.TestCore::testDefine 0.011sec`
* `javax0.jamal.test.core.TestCore::testDefine 0.002sec`
* `javax0.jamal.test.core.TestCore::testDefine 0.001sec`
* `javax0.jamal.test.core.TestCore::testDefine 0.001sec`
* `javax0.jamal.test.core.TestCore::testDefine 0.001sec`
...
* `javax0.jamal.test.core.TestCore::testDefine 0.002sec`
* `javax0.jamal.test.core.TestCore::testDefine 0.001sec`
* `javax0.jamal.test.core.TestCore::testDefine 0.0sec`
* `javax0.jamal.test.core.TestCore::testDefine 0.0sec`
* `javax0.jamal.test.core.TestCore::testDefine 0.001sec`
* `javax0.jamal.test.core.TestCore::testDefine 0.001sec`
* `javax0.jamal.test.core.TestCore::testDefine 0.001sec`
...
* `javax0.jamal.test.core.TestCore::testDefine 0.001sec`
* `javax0.jamal.test.core.TestCore::testDefine 0.001sec`
* `javax0.jamal.test.core.TestCore::testEngine 0.001sec`
* `javax0.jamal.test.core.TestCore::testEngine 0.002sec`
* `javax0.jamal.test.core.TestCore::testEngine 0.001sec`
* `javax0.jamal.test.core.TestCore::testEngine 0.244sec`
* `javax0.jamal.test.core.TestCore::testEngine 0.19sec`
...
* `javax0.jamal.test.core.TestCore::testRecursiveMacro 0.172sec`
* `javax0.jamal.test.core.TestCore::testRecursiveMacro 0.205sec`
* `Total: 2.3530sec`
...
* `javax0.jamal.test.core.TestInclude::testDescendingRange 0.002sec`
* `javax0.jamal.test.core.TestInclude::testOneLineRange 0.003sec`
...
* `javax0.jamal.test.core.TestInclude::testRangeWithTooLargeBoundary 0.002sec`
...
* `javax0.jamal.test.statecheck.TestCheckState::testCheckState 0.001sec`
* `javax0.jamal.test.statecheck.TestCheckState::testCheckStateSwitchOffForGlobal 0.001sec`
* `javax0.jamal.test.statecheck.TestCheckState::testCheckStateInTry 0.002sec`
* `javax0.jamal.test.statecheck.TestCheckState::testCheckStateTwice 0.002sec`
...
* `javax0.jamal.test.parser.TestParser::simpleTest 0.001sec`
* `javax0.jamal.test.parser.TestParser::testWithSepLocal 0.002sec`
* `javax0.jamal.test.parser.TestParser::testWithSep 0.001sec`
* `javax0.jamal.test.parser.TestParser::testEscape 0.002sec`
* `javax0.jamal.test.parser.TestParser::testWithSepSep 0.001sec`
* `javax0.jamal.test.parser.TestParser::testUndefBiMacro 0.001sec`
* `Total: 0.0110sec`
...
// execute a little BASIC formatted code for each XML
* `javax0.jamal.test.examples.TestIOHooks::testIOHooks 0.002sec`
* `Total: 0.0020sec`
...
// execute a little BASIC formatted code for each XML
* `javax0.jamal.test.examples.TestSpacer::spacerSpacesInput 0.002sec`
* `Total: 0.0020sec`
...
// execute a little BASIC formatted code for each XML
* `javax0.jamal.test.json.TestConvertJsonReadme::generateDoc 0.025sec`
* `Total: 0.0250sec`
...
// execute a little BASIC formatted code for each XML
* `javax0.jamal.test.core.TestRequire::testFutureVersion 0.005sec`
* `javax0.jamal.test.core.TestRequire::testCurrentExactVersion 0.007sec`
* `javax0.jamal.test.core.TestRequire::testCurrentVersionAsString 0.001sec`
* `javax0.jamal.test.core.TestRequire::testFutureVersionOK 0.016sec`
* `Total: 0.0290sec`



Total Test Time: `4.2710sec`