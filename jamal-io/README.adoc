...
[source]
----
{@maven:load com.javax0.jamal:jamal-io:2.2.0-SNAPSHOT}
----
...
It is usually useful when a document is fetches some binary information via the web and wants to store it locally attached to the document.
...
After that tim,e, the picture us deleted and the
