 ...
 * is not secure.
 */
public class Integration_ConfigurationNotSecure {
    @DisplayName("Non-secure configuration fails any maven:load")
    @Test
    void test() throws Exception {
        TestThat.theInput(String.format("{@maven:load com.javax0.jamal:jamal-test:%s}", JamalVersion.get()))
                .throwsUp(IllegalStateException.class, "INSECURE CONFIGURATION.*");
    }
