...
* `ASCIIDOC_EXTENSION_FROM_FILE` can be `true` or `false`.
When set to true the Jamal preprocessor will read the content of the saved file instead of the lines provided by the Asciidoctor plugin to preprocess.
