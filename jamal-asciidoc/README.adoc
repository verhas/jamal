...
This document is the readme file for the Jamal Asciidoc extension version `2.3.0-SNAPSHOT`.
...
To use the plugin together with the IntelliJ Asciidoc plugin, you need the file `jamal-asciidoc-2.2.0-jamal-asciidoc-distribution.zip`.

You can download this file from the central Maven repository using the URLs:



https://repo.maven.apache.org/maven2/com/javax0/jamal/jamal-asciidoc/2.2.0/jamal-asciidoc-2.2.0-jamal-asciidoc-distribution.zip[``https://repo.maven.apache.org/maven2/com/javax0/jamal/jamal-asciidoc/2.2.0/jamal-asciidoc-2.2.0-jamal-asciidoc-distribution.zip``]

https://repo.maven.apache.org/maven2/com/javax0/jamal/jamal-asciidoc/2.2.0/jamal-asciidoc-2.2.0-jamal-asciidoc-distribution.zip.asc[``https://repo.maven.apache.org/maven2/com/javax0/jamal/jamal-asciidoc/2.2.0/jamal-asciidoc-2.2.0-jamal-asciidoc-distribution.zip.asc``]

https://repo.maven.apache.org/maven2/com/javax0/jamal/jamal-asciidoc/2.2.0/jamal-asciidoc-2.2.0-jamal-asciidoc-distribution.zip.md5[``https://repo.maven.apache.org/maven2/com/javax0/jamal/jamal-asciidoc/2.2.0/jamal-asciidoc-2.2.0-jamal-asciidoc-distribution.zip.md5``]

https://repo.maven.apache.org/maven2/com/javax0/jamal/jamal-asciidoc/2.2.0/jamal-asciidoc-2.2.0-jamal-asciidoc-distribution.zip.sha1[``https://repo.maven.apache.org/maven2/com/javax0/jamal/jamal-asciidoc/2.2.0/jamal-asciidoc-2.2.0-jamal-asciidoc-distribution.zip.sha1``]
...
The installation for AsciidocFX needs to copy all the JAR files dowloadable from Maven central
...
The reason for that is AsciidocFX using older versions of many of the libraries.
The message recommends to remove the older versions.
Please, do that.

NOTE: There is no guarantee that this will work.
As for Jamal 2.2.0 and AsciidocFX 1.8.5 the experiments whosed that there were no issues running AsccidocFX with Jamal.
...
The API of the two versions are not compatible, and it may cause issues in some cases.

After the files are copied to the `lib` folder you need to restart AsciidocFX and that is it.
AsciidocFX 1.8.5 and later versions recognize `.jam` as Asciidoc extension and will work properly.
...
[source]
----
{#if /{@env intellij.asciidoctor.plugin}/This was compiled in IntelliJ or AsciidocFX/This was compiled outside of IntelliJ or AsciidocFX/}
----
...
[source]
----
This was compiled outside of IntelliJ or AsciidocFX/
----
...
The use case to use the environment variable is executing external processors or retrieving expensive resources.
Examples:
