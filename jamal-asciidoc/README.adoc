...
When you edit a text file the extension is anything ending with `.jam` but none of the Asciidoc or Markdown extensions.
...
This asciidoctor plugin not only gives the Jamal processed output to the Asciidoctor IntelliJ plugin, but also saves this result to a file.
