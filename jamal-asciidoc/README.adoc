...
This document is the readme file for the Jamal AsciiDoc extension version `2.8.3-SNAPSHOT`.
...
This command will install the extension into the `.Asciidoctor/lib` directory, where the Asciidoctor plugin is looking for its extensions.
