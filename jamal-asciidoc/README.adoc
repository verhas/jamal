...
This document is the readme file for the Jamal Asciidoc extension version `2.8.1`.
...
To use the plugin together with the IntelliJ Asciidoc plugin, you need the file `jamal-asciidoc-2.8.1-jamal-asciidoc-distribution.zip`.
...
To do that, execute the command
    ...
    jbang jamal@verhas -jamalize version=2.8.1
