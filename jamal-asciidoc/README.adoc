...
This document is the readme file for the Jamal Asciidoc extension version `2.0.3-SNAPSHOT`.
...
To use the plugin together with the IntelliJ Asciidoc plugin, you need the file `jamal-asciidoc-2.0.2-jamal-asciidoc-distribution.zip`.

You can download this file from the central Maven repository using the URLs:


https://repo.maven.apache.org/maven2/com/javax0/jamal/jamal-asciidoc/2.0.2/jamal-asciidoc-2.0.2-jamal-asciidoc-distribution.zip[``https://repo.maven.apache.org/maven2/com/javax0/jamal/jamal-asciidoc/2.0.2/jamal-asciidoc-2.0.2-jamal-asciidoc-distribution.zip``]

https://repo.maven.apache.org/maven2/com/javax0/jamal/jamal-asciidoc/2.0.2/jamal-asciidoc-2.0.2-jamal-asciidoc-distribution.zip.asc[``https://repo.maven.apache.org/maven2/com/javax0/jamal/jamal-asciidoc/2.0.2/jamal-asciidoc-2.0.2-jamal-asciidoc-distribution.zip.asc``]

https://repo.maven.apache.org/maven2/com/javax0/jamal/jamal-asciidoc/2.0.2/jamal-asciidoc-2.0.2-jamal-asciidoc-distribution.zip.md5[``https://repo.maven.apache.org/maven2/com/javax0/jamal/jamal-asciidoc/2.0.2/jamal-asciidoc-2.0.2-jamal-asciidoc-distribution.zip.md5``]

https://repo.maven.apache.org/maven2/com/javax0/jamal/jamal-asciidoc/2.0.2/jamal-asciidoc-2.0.2-jamal-asciidoc-distribution.zip.sha1[``https://repo.maven.apache.org/maven2/com/javax0/jamal/jamal-asciidoc/2.0.2/jamal-asciidoc-2.0.2-jamal-asciidoc-distribution.zip.sha1``]
