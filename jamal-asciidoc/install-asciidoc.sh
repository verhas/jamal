...
#
echo "Compiling and installing the Jamal asciidotor plugin only"
mvn clean install
...
unzip ~/.m2/repository/com/javax0/jamal/jamal-asciidoc/1.12.6-SNAPSHOT/jamal-asciidoc-1.12.6-SNAPSHOT-jamal-asciidoc-distribution.zip >/dev/null
