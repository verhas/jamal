...
For example:
  ...
  maven.load.include=com.javax0.jamal:jamal-scriptbasic:2.5.1-SNAPSHOT

* add the line

  {@maven:load com.javax0.jamal:jamal-scriptbasic:2.5.1-SNAPSHOT}
+
...
* To include the resource file `scriptbasic.jim` you have to add the line
  ...
  {@import maven:com.javax0.jamal:jamal-scriptbasic:2.5.1-SNAPSHOT::scriptbasic.jim}
+
