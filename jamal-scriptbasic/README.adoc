...
Starting with the version `1.12.7` the library is not configured to be on the class path of the command line version or the Asciidoctor preprocessor.
...
For example:
  ...
  maven.load.include=com.javax0.jamal:jamal-scriptbasic:1.12.7-SNAPSHOT

* add the line

  {@maven:load com.javax0.jamal:jamal-scriptbasic:1.12.7-SNAPSHOT}
+
...
* To include the resource file `scriptbasic.jim` you have to add the line
  ...
  {@import maven:com.javax0.jamal:jamal-scriptbasic:1.12.7-SNAPSHOT::scriptbasic.jim}
+
