...
[source]
----
mvn -Djamalize=true com.javax0.jamal:jamal-maven-plugin:1.12.7-SNAPSHOT:jamal
----
...
Experimental module providing macros to load Java classes and call their methods.
