...
Following the version 2.5.1 it is possible and recommended to specify the name of the macro using the annotation `@Name`.
...
This feature is available since the release 2.5.1.
