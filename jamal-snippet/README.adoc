...
<groupId>com.javax0.jamal</groupId><artifactId>jamal-snippet</artifactId><version>1.10.4-SNAPSHOT</version>
</project>
}
----
...
Although the macro <<xmlFormat,`xmlFormat`>> can also do the conversion it does other things also.
If the output is not a full XML then the format may fail.
