...
[source]
----
/Users/verhasp/github/jamal/jamal-snippet/README.adoc.jam:1304:30
----
...
<groupId>com.javax0.jamal</groupId><artifactId>jamal-snippet</artifactId><version>2.0.1-SNAPSHOT</version>
</project>
}
----
