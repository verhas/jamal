...
The snippet `collect_options` is defined in the file `Collect.java` at the line 47.
...
These are `skip`, `range`, `kill` and `replace`.
...
- SnipTransform.java: 16,264 bytes
- FilesMacro.java: 5,190 bytes
- Collect.java: 17,752 bytes
- SnipFile.java: 680 bytes
- TrimLines.java: 4,196 bytes
...
<groupId>com.javax0.jamal</groupId><artifactId>jamal-snippet</artifactId><version>1.11.3-SNAPSHOT</version>
</project>
}
----
