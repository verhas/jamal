...
- JavaSourceInsert.java: 4,685 bytes
...
<groupId>com.javax0.jamal</groupId><artifactId>jamal-snippet</artifactId><version>2.0.3-SNAPSHOT</version>
</project>
}
----
...
The parameters are not enclosed.
