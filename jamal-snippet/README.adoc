...
The snippet `collect_options` is defined in the file `Collect.java` at the line 46.
...
It can kill/keep lines, skip, replace, trim lines, it can reflow the lines, replace tabs with spaces, and it can number the lines.
...
- SnipTransform.java: 14,715 bytes
- FilesMacro.java: 5,196 bytes
- Collect.java: 15,811 bytes
- SnipFile.java: 680 bytes
- TrimLines.java: 4,171 bytes
...
- KillLines.java: 2,012 bytes
- SnipLoad.java: 3,530 bytes
- SnippetStore.java: 10,222 bytes
