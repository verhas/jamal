...
[source]
----
/Users/verhasp/github/jamal/jamal-snippet/README.adoc.jam:964:30
----
...
* `$relativePath` the relative path to the directory (absolute as for now)
