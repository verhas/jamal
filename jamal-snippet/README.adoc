...
[source]
----
/Users/verhasp/github/jamal/jamal-snippet/README.adoc.jam:1321:30
----
...
- Collect.java
- SnipFile.java
- JavaMatcherBuilderMacros.java.jam
- TrimLines.java
...
- JavaMatcherBuilderMacros.java.jam: 1,855 bytes
...
- CompileJavaMacros.java: 17,253 bytes
...
<groupId>com.javax0.jamal</groupId><artifactId>jamal-snippet</artifactId><version>2.1.0-SNAPSHOT</version>
</project>
}
----
...
To do that, the macro has two parameters:
...
The singular versions are used for formatting.
