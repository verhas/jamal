...
Last updated: 2021-01-21 14:34:42
...
* `$isDirectory` will be replaced by the string literal `true` if the file is a directory otherwise by `false`.
* `$isFile` will be replaced by the string literal `true` if the file is a plain file otherwise by `false`.
* `$isHidden` will be replaced by the string literal `true` if the file is hidden otherwise by `false`.
* `$canExecute` will be replaced by the string literal `true` if the file can be executed or can be listed if it is a directory otherwise by `false`.
* `$canRead` will be replaced by the string literal `true` if the file is readable otherwise by `false`.
* `$canWrite` will be replaced by the string literal `true` if the file is writeable otherwise by `false`.
* `$size` will be replaced by the size of the file.
* `$time` will be replaced by the last modification time of the file.
