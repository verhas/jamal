...
[source]
----
The current version 2.4.1-SNAPSHOT is older than the required version. It has to be newer.
----
...
[source]
----
This documentation was processed using the version 2.4.1-SNAPSHOT
----
...
The version of the documented code is in the `pom.xml` file: `2.4.1-SNAPSHOT`.
