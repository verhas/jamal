...
You can use this option instead of the `!` character.
The option `noRedefine` can also be used in the link:options[`options`] macro setting this behavior for all the macros defined after it within the scope of the option.
