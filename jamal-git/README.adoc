...
[source]
----
The latest commit to Jamal is: "My-Special: sample footnote message message for documentation Rev: git macro module"
----
...
In the following example we print the footnote `my-special` and also the full commit message for a special commit of the Jamal git repository:

.Jamal source
[source]
----
footnote: {@git:commit ref=178bb91bdc88c4c133c8429c46107483397fbc81
footnote=my-special}\
message: {@git:commit ref=178bb91bdc88c4c133c8429c46107483397fbc81
message}
----
...
Footnote lines end with a new line character, even if the commit message is not terminated with one.
