...
public class TestCommit {
    ...
    public void latestCommiFootnote() throws Exception {
        TestThat.theInput("{@git location=\"" + repoDir.getAbsolutePath() + "\"}{@git:commit branch=main last footnote=rev}")
    ...
    public void latestCommitMessage() throws Exception {
        TestThat.theInput("{@git location=\"" + repoDir.getAbsolutePath() + "\"}{@git:commit branch=main last message}")
    ...
    public void lastButOneCommitMessage() throws Exception {
        TestThat.theInput("{@git location=\"" + repoDir.getAbsolutePath() + "\"}{@git:commit branch=main index=1 message}")
    ...
    public void lastButOneCommitFootnote() throws Exception {
        TestThat.theInput("{@git location=\"" + repoDir.getAbsolutePath() + "\"}{@git:commit branch=main index=1 footnote=rev}")
                .results("chucken\nwas added\n");
    }
    ...
    public void allCommitHashes() throws Exception {
        TestThat.theInput("{@git location=\"" + repoDir.getAbsolutePath() + "\"}{@git:commits branch=main hash}")
    ...
    public void limitedCommitHashes() throws Exception {
        TestThat.theInput("{@git location=\"" + repoDir.getAbsolutePath() + "\"}{@git:commits branch=main hash limit=1}")
