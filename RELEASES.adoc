...
=== https://github.com/verhas/jamal/tree/1.10.5-SNAPSHOT[1.10.5-SNAPSHOT]
...
Root directory finding and converting all jamal files with exclude/include list is part of the APO.
...
The project root directory is the directory above the current working directory that

* is less than 100 level above the current working directory AND
* contains a file or directory named
