...
The packaging of the applicatios is a super jar, so there is no need for any dependencies on the command line.
...
The behaviour can be altered with command line arguments.
