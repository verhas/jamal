...
public class TestInclude {
    ...
    void testPartialInclude() throws Exception {
        TestThat.theInput("{@include [lines=1..2] res:import/lineNumbers.txt}").results("01\n02\n");
    }

    @Test
    @DisplayName("Multiple ranges can be specified")
    void testMultipleRanges() throws Exception {
        TestThat.theInput("{@include [lines=1..2,10..14,16..18] res:import/lineNumbers.txt}").results("01\n02\n10\n11\n12\n13\n14\n16\n17\n18\n");
    }

    @Test
    @DisplayName("You can specify a range using negative numbers")
    void testNegativeRange() throws Exception {
        TestThat.theInput("{@include [lines=-1..-2] res:import/lineNumbers.txt}").results("19\n18\n");
    }

    @Test
    @DisplayName("A one-line range can be specified with a single number")
    void testOneLineRange() throws Exception {
        TestThat.theInput("{@include [lines=1] res:import/lineNumbers.txt}").results("01\n");
    }
    ...
    void testOneLineRangeWithMultipleRanges() throws Exception {
        TestThat.theInput("{@include [lines=1..2,7,-2..-1] res:import/lineNumbers.txt}").results("01\n02\n07\n18\n19\n");
    }

    @Test
    @DisplayName("A range can also descent")
    void testDescendingRange() throws Exception {
        TestThat.theInput("{@include [lines=10..1] res:import/lineNumbers.txt}").results("10\n09\n08\n07\n06\n05\n04\n03\n02\n01\n");
    }

    @Test
    @DisplayName("Ranges can be specified with spaces arbitrary in the middle")
    void testRangeWithSpaces() throws Exception {
        TestThat.theInput("{@include [lines=\"1.. 2,  3.. 4,  5.. 7\"] res:import/lineNumbers.txt}").results("01\n02\n03\n04\n05\n06\n07\n");
    }
    ...
    void testRangeWithTooLargeBoundary() throws Exception {
        TestThat.theInput("{@include [lines=18..100] res:import/lineNumbers.txt}").results("18\n19\n");
    }

    @Test
    @DisplayName("Range boundary too small just gets capped")
    void testRangeWithTooSmallBoundary() throws Exception {
        TestThat.theInput("{@include [lines=-100..+1] res:import/lineNumbers.txt}").results("01\n");
    }
